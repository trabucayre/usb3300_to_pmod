...
from gateware.common import add_usb3300_pmod

# Platform -----------------------------------------------------------------------------------------
class Platform(digilent_arty_s7.Platform):
    def create_programmer(self):
        board_name = {True: "arty_s7_50", False: "arty_s7_25"}["xc7s50" in self.device]
...
class BaseSoC(SoCCore):
    def __init__(self, variant="s7-50", sys_clk_freq=100e6,
        ...
        **kwargs):
        ...
        platform.add_extension(add_usb3300_pmod(name="usb"))
...
def main():
    ...
    parser = LiteXArgumentParser(platform=Platform, description="LiteX SoC on Arty S7.")
